...
/datum/mutation/human/hulk/say_mod(message)
	if(message)
		message = "[uppertext(replacetxt(message, ".", "!"))]!!"
	return message
...
/datum/mutation/human/smile/say_mod(message)
	if(message)
		...
		message = replacetxt(message," stupid "," smart ")
		message = replacetxt(message," retard "," genius ")
		message = replacetxt(message," unrobust "," robust ")
		message = replacetxt(message," dumb "," smart ")
		message = replacetxt(message," awful "," great ")
		message = replacetxt(message," gay ",pick(" nice "," ok "," alright "))
		message = replacetxt(message," horrible "," fun ")
		message = replacetxt(message," terrible "," terribly fun ")
		message = replacetxt(message," terrifying "," wonderful ")
		message = replacetxt(message," gross "," cool ")
		message = replacetxt(message," disgusting "," amazing ")
		message = replacetxt(message," loser "," winner ")
		message = replacetxt(message," useless "," useful ")
		message = replacetxt(message," oh god "," cheese and crackers ")
		message = replacetxt(message," jesus "," gee wiz ")
		message = replacetxt(message," weak "," strong ")
		message = replacetxt(message," kill "," hug ")
		message = replacetxt(message," murder "," tease ")
		message = replacetxt(message," ugly "," beautiful ")
		message = replacetxt(message," douchbag "," nice guy ")
		message = replacetxt(message," whore "," lady ")
		message = replacetxt(message," nerd "," smart guy ")
		message = replacetxt(message," moron "," fun person ")
		message = replacetxt(message," IT'S LOOSE "," EVERYTHING IS FINE ")
		message = replacetxt(message," sex "," hug fight ")
		message = replacetxt(message," idiot "," genius ")
		message = replacetxt(message," fat "," thin ")
		message = replacetxt(message," beer "," water with ice ")
		message = replacetxt(message," drink "," water ")
		message = replacetxt(message," feminist "," empowered woman ")
		message = replacetxt(message," i hate you "," you're mean ")
		message = replacetxt(message," nigger "," african american ")
		message = replacetxt(message," jew "," jewish ")
		message = replacetxt(message," shit "," shiz ")
		message = replacetxt(message," crap "," poo ")
		message = replacetxt(message," slut "," tease ")
		message = replacetxt(message," ass "," butt ")
		message = replacetxt(message," damn "," dang ")
		message = replacetxt(message," fuck ","  ")
		message = replacetxt(message," penis "," privates ")
		message = replacetxt(message," cunt "," privates ")
		message = replacetxt(message," dick "," jerk ")
		message = replacetxt(message," vagina "," privates ")
	return trim(message)
...
/datum/mutation/human/swedish/say_mod(message)
	if(message)
		message = replacetxt(message,"w","v")
		if(prob(30))
