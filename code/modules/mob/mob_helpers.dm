...
/proc/lisp(message, intensity=100) //Intensity = how hard will the dude be lisped
	message = prob(intensity) ? replacetxt(message, "f", "ph") : message
	message = prob(intensity) ? replacetxt(message, "t", "ph") : message
	message = prob(intensity) ? replacetxt(message, "s", "sh") : message
	message = prob(intensity) ? replacetxt(message, "th", "hh") : message
	message = prob(intensity) ? replacetxt(message, "ck", "gh") : message
	message = prob(intensity) ? replacetxt(message, "c", "gh") : message
	message = prob(intensity) ? replacetxt(message, "k", "gh") : message
	return message
...
/proc/derpspeech(message, stuttering)
	message = replacetxt(message, " am ", " ")
	message = replacetxt(message, " is ", " ")
	message = replacetxt(message, " are ", " ")
	message = replacetxt(message, "you", "u")
	message = replacetxt(message, "help", "halp")
	message = replacetxt(message, "grief", "grife")
	message = replacetxt(message, "space", "spess")
	message = replacetxt(message, "carp", "crap")
	message = replacetxt(message, "reason", "raisin")
	if(prob(50))
