...
/proc/buttificate(phrase)
	...
	finalphrase = replacetxt(finalphrase, " #39 ","'")
	finalphrase = replacetxt(finalphrase, " s "," ") //this is really dumb and hacky, gets rid of trailing 's' character on the off chance that '#39' gets swapped
