...
/obj/item/clothing/mask/gas/voice/space_ninja/speechModification(message)
	if(voice == "Unknown")
		if(copytext(message, 1, 2) != "*")
			...
			message = replacetxt(message, "l", "r")
			message = replacetxt(message, "rr", "ru")
			message = replacetxt(message, "v", "b")
			message = replacetxt(message, "f", "hu")
			message = replacetxt(message, "'t", "")
			message = replacetxt(message, "t ", "to ")
			message = replacetxt(message, " I ", " ai ")
			message = replacetxt(message, "th", "z")
			message = replacetxt(message, "is", "izu")
			message = replacetxt(message, "ziz", "zis")
			message = replacetxt(message, "se", "su")
			message = replacetxt(message, "br", "bur")
			message = replacetxt(message, "ry", "ri")
			message = replacetxt(message, "you", "yuu")
			message = replacetxt(message, "ck", "cku")
			message = replacetxt(message, "eu", "uu")
			message = replacetxt(message, "ow", "au")
			message = replacetxt(message, "are", "aa")
			message = replacetxt(message, "ay", "ayu")
			message = replacetxt(message, "ea", "ii")
			message = replacetxt(message, "ch", "chi")
			message = replacetxt(message, "than", "sen")
			message = replacetxt(message, ".", "")
