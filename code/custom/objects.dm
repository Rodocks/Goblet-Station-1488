...
/obj/structure/flora/tree/goon
	name = "Tree"
	desc = "It's a tree."
	icon = 'icons/custom/goon96x96.dmi' // changed from worlds.dmi
	icon_state = "tree" // changed from 0.0
	anchored = 1
	layer = 9
	pixel_x = -20
	density = 1
	opacity = 0 // this causes some of the super ugly lighting issues HOLY SHIT AJ THESE GOON CODERS ARE SMART
...
/obj/effect/spawner/lootdrop/Wizardshit
	name = "Wizrd wand spawner"
	lootdoubles = 0

	loot = list(
				/obj/item/weapon/gun/magic/staff/door = 2,
				/obj/item/weapon/gun/magic/staff/change = 3,
				/obj/item/weapon/gun/magic/staff/healing = 8,
				/obj/item/weapon/gun/projectile/revolver/mateba = 5,
				/obj/item/weapon/gun/magic/staff/animate = 1,
				/obj/item/weapon/gun/magic/staff/chaos = 1,
				)

/obj/structure/window/autismbarwindowthatiamgoningtouseforthisoneautismfortinarrivalsthispathinstlongwindedatall
	icon = 'icons/obj/smooth_structures/window.dmi'
	icon_state = "window"
	desc = "Wow rodocks REALLY doesn't want you to get in there"
	dir = 5
	maxhealth = 666
	fulltile = 1
	can_be_unanchored = 0
...
/obj/effect/decal/floatingtiles
	...
	density = 0
	anchored = 1
	icon = 'icons/custom/3dimension.dmi'
	icon_state = "floattiles1"

/area/template/pmc/void/
	name = "void_area"
	requires_power = 0
	has_gravity = 1
	icon = 'icons/custom/objects.dmi'
...
/obj/effect/decal/skeleton
	name = "..."
	desc = "..."
	opacity = 0
	density = 0
	anchored = 1
	icon = 'icons/custom/hstation.dmi'
	icon_state = "body7"

/turf/simulated/wall/shuttle/constructwalls
	name = "wall"
	desc = "God is dead"
	icon_state = "wall"
	icon = 'icons/custom/construction_walls.dmi'

/turf/simulated/wall/shuttle/moonwindow
	name = "wall"
	desc = "God is dead"
	icon_state = "leadwindow_white_1"
	icon = 'icons/custom/worlds.dmi'
	opacity = 0

/obj/effect/decal/float
	New()
		..()
		.= rand(5, 20)
...
/area/template/pmc/rodocks/
	...
	/obj/effect/decal/bigspin
	New()
		..()

		var/icon/i = icon(icon)
		animate(src, transform = turn(matrix(), 120), time = 30, loop = 5)
		animate(transform = turn(matrix(), 240), time = 30)
		animate(transform = null, time = 30)
		i.Scale(128, 128)
		icon = i
	/obj/effect/decal/bigspin/moon
		name = "moon"
		desc = "That's unusual."
		icon = 'icons/custom/lunar64.dmi'
		icon_state = "moon"

/turf/simulated/floor/void/timewarp
	name = "time-space breach"
	desc = "Uhh.  UHHHH.  uh."
	//RL_Ignore = 0 I have no idea what this is so FUCK IT
	icon = 'icons/custom/worlds.dmi'
	icon_state = "timehole"
