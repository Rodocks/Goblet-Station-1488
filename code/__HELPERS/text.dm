...
// See bygex.dm
#ifndef USE_BYGEX
/proc/replacetxt(text, find, replacement)
	return list2text(text2list(text, find), replacement)

/proc/replacetxtEx(text, find, replacement)
...
/proc/parsepencode(t, mob/user=null, signfont=SIGNFONT)
	...
	t = replacetxt(t, "\[center\]", "<center>")
	t = replacetxt(t, "\[/center\]", "</center>")
	t = replacetxt(t, "\[br\]", "<BR>")
	t = replacetxt(t, "\[b\]", "<B>")
	t = replacetxt(t, "\[/b\]", "</B>")
	t = replacetxt(t, "\[i\]", "<I>")
	t = replacetxt(t, "\[/i\]", "</I>")
	t = replacetxt(t, "\[u\]", "<U>")
	t = replacetxt(t, "\[/u\]", "</U>")
	t = replacetxt(t, "\[large\]", "<font size=\"4\">")
	t = replacetxt(t, "\[/large\]", "</font>")
	if(user)
		t = replacetxt(t, "\[sign\]", "<font face=\"[signfont]\"><i>[user.real_name]</i></font>")
	else
		t = replacetxt(t, "\[sign\]", "")
	t = replacetxt(t, "\[field\]", "<span class=\"paper_field\"></span>")

	t = replacetxt(t, "\[*\]", "<li>")
	t = replacetxt(t, "\[hr\]", "<HR>")
	t = replacetxt(t, "\[small\]", "<font size = \"1\">")
	t = replacetxt(t, "\[/small\]", "</font>")
	t = replacetxt(t, "\[list\]", "<ul>")
	t = replacetxt(t, "\[/list\]", "</ul>")
